...
function aggregatedMapHandler(meanioinstance, req, res) {
    res.setHeader('content-type', 'application/octet-stream');
    meanioinstance.aggregated('map', req.query.group ? req.query.group : 'footer', aggregatedJSSender.bind(null,res));
}
...
function findModulesDone (meanioinstance, app, defer) {
  ...
  if(config.aggregation!==false){
    ...
    app.get('/modules/aggregated.map', aggregatedMapHandler.bind(null,meanioinstance));
